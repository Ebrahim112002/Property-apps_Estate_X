...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      await _authService.signUp(_emailController.text, _passwordController.text, _nameController.text, _role);
      if (mounted) {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            _isLoading ? const CircularProgressIndicator(color: Colors.white) : _buildButton("Register", _register),
  ...
  Widget _buildRoleDropdown() => Container(
    ...
    child: DropdownButtonHideUnderline(
      child: DropdownButton<String>(
        value: _role, dropdownColor: Colors.blueGrey.shade900, isExpanded: true, style: const TextStyle(color: Colors.white),
        items: const [DropdownMenuItem(value: 'buyer', child: Text("I am a Buyer")), DropdownMenuItem(value: 'seller', child: Text("I am a Seller/Agent"))],
